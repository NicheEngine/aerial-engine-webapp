...
const getDefaultPwaOptions = (name: string): Partial<PwaPluginOptions> => ({
  manifest: {
    ...
    icons: [
      {
        sizes: '192x192',
        src: 'https://unpkg.com/@aerial-enginejs/static-source@0.1.7/source/pwa-icon-192.png',
        type: 'image/png',
      },
      {
        sizes: '512x512',
        src: 'https://unpkg.com/@aerial-enginejs/static-source@0.1.7/source/pwa-icon-512.png',
        type: 'image/png',
      },
    ],
