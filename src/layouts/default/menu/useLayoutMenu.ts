import type { Menu } from '/@/routers/types'
...
import { getChildrenMenus, getCurrentParentPath, getMenus, getShallowMenus } from '/@/routers/menus'
import { usePurviewStore } from '/@/store/modules/purview'
...
export function useSplitMenu(splitType: Ref<MenuSplitTyeEnum>) {
  ...
  // Menu changes
  watch(
    [() => purviewStore.getLastBuildMenuTime, () => purviewStore.getBackMenuList],
    () => {
      genMenus()
    },
    {
