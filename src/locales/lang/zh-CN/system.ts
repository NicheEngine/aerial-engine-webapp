export default {
  api: {
    ...
    status_404: '网络请求错误,未找到该资源!',
    status_405: '网络请求错误,请求方法未允许!',
    status_408: '网络请求超时!',
    status_500: '服务器错误,请联系管理员!',
    status_501: '网络未实现!',
    status_502: '网络错误!',
    status_503: '服务不可用，服务器暂时过载或维护!',
    status_504: '网络超时!',
    status_505: 'http版本不支持该请求!',
  },
  ...
  errorLog: {
    ...
    enableMessage: '只在`/define/settings/projectSetting.ts` 内的useErrorHandle=true时生效.',
  },
  exception: {
    backLogin: '返回登录',
    backHome: '返回首页',
    subTitle_403: '抱歉，您无权访问此页面。',
    subTitle_404: '抱歉，您访问的页面不存在。',
    subTitle_500: '抱歉，服务器报告错误。',
    noDataTitle: '当前页无数据',
