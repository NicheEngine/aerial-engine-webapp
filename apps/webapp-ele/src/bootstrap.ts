...
import { initSetupEngineForm } from './adapter/form';
...
async function bootstrap(namespace: string) {
  ...
  // 注册Engine提供的v-loading和v-spinning指令
  registerLoadingDirective(app, {
    loading: false, // Engine提供的v-loading指令和Element Plus提供的v-loading指令二选一即可，此处false表示不注册Engine提供的v-loading指令
    spinning: 'spinning',
  });
