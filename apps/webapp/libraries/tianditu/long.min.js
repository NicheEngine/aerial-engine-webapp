...
(function (d, g) {
  ...
  function m(a, b) {
    ...
    if (b) {
      a >>>= 0;
      if ((t = 0 <= a && 256 > a)) if ((c = z[a])) return c;
      c = e(a, 0 > (a | 0) ? -1 : 0, !0);
      t && (z[a] = c);
    } else {
      a |= 0;
      if ((t = -128 <= a && 128 > a)) if ((c = A[a])) return c;
      c = e(a, 0 > a ? -1 : 0, !1);
      t && (A[a] = c);
    }
    return c;
  ...
  function x(a, b, c) {
    ...
    for (var e = k, f = 0; f < a.length; f += 8) {
      ...
      8 > d
        ? ((d = n(v(c, d))), (e = e.mul(d).add(n(g))))
        : ((e = e.mul(t)), (e = e.add(n(g))));
    }
    e.unsigned = b;
    return e;
  }
  ...
  b.multiply = function (a) {
    ...
    return e((s << 16) | (r & 65535), (u << 16) | h, this.unsigned);
  };
  b.mul = b.multiply;
  b.divide = function (a) {
    g(a) || (a = q(a));
