...
*/
(function (k, m) {
  if ('function' === typeof define && define.amd) define(['long'], m);
  else if (
  ...
  function r() {
    ...
    return function () {
      ...
      1024 < a.length + arguments.length &&
        (b.push(w.apply(String, a)), (a.length = 0));
  ...
  function u(a, b, c, d, f, l) {
    ...
    isNaN(b) || Infinity === b
      ...
      : ((d = Math.floor(Math.log(b) / Math.LN2)),
        ...
        (b = 1 <= d + k ? b + p / g : b + p * Math.pow(2, 1 - k)),
        2 <= b * g && (d++, (g /= 2)),
        d + k >= h
          ? ((b = 0), (d = h))
          : 1 <= d + k
            ? ((b = (b * g - 1) * Math.pow(2, f)), (d += k))
            : ((b = b * Math.pow(2, k - 1) * Math.pow(2, f)), (d = 0)));
  ...
  var h = function (a, b, c) {
    'undefined' === typeof a && (a = h.DEFAULT_CAPACITY);
  ...
  h.Long = k || null;
  var e = h.prototype;
  Object.defineProperty(e, '__isByteBuffer__', {
    value: !0,
    enumerable: !1,
    configurable: !1,
  });
  ...
  h.concat = function (a, b, c, d) {
    if ('boolean' === typeof b || 'string' !== typeof b)
      ((d = c), (c = b), (b = void 0));
    for (var f = 0, l = 0, g = a.length, e; l < g; ++l)
      (h.isByteBuffer(a[l]) || (a[l] = h.wrap(a[l], b)),
        (e = a[l].limit - a[l].offset),
        0 < e && (f += e));
    ...
    for (l = 0; l < g; )
      ((c = a[l++]),
        (e = c.limit - c.offset),
        0 >= e ||
          (b.view.set(c.view.subarray(c.offset, c.limit), b.offset),
          (b.offset += e)));
    b.limit = b.offset;
    b.offset = 0;
    return b;
    ...
    if (a instanceof Uint8Array)
      ((b = new h(0, c, d)),
        0 < a.length &&
          ...
          (b.limit = a.byteOffset + a.byteLength),
          (b.view = new Uint8Array(a.buffer))));
      ...
      ((b = new h(0, c, d)),
        0 < a.byteLength &&
          ...
          (b.view = 0 < a.byteLength ? new Uint8Array(a) : null)));
    else if ('[object Array]' === Object.prototype.toString.call(a))
      for (
        b = new h(a.length, c, d), b.limit = a.length, c = 0;
        c < a.length;
        ++c
      )
        b.view[c] = a[c];
  ...
  e.writeBitSet = function (a, b) {
    ...
    if (!this.noAssert) {
      ...
      if (0 > b || b + 0 > this.buffer.byteLength)
        throw RangeError(
          'Illegal offset: 0 <= ' + b + ' (+0) <= ' + this.buffer.byteLength,
        );
    }
    var d = b,
      f = a.length,
  ...
  e.readBitSet = function (a) {
    ...
    for (a += c.length; f--; )
      ((c = this.readByte(a++)),
        ...
        (g[e++] = !!(c & 128)));
    if (e < d)
      for (f = 0, c = this.readByte(a++); e < d; ) g[e++] = !!((c >> f++) & 1);
    b && (this.offset = a);
    return g;
  };
  ...
  e.readInt8 = function (a) {
    ...
    if (!this.noAssert) {
      ...
      if (0 > a || a + 1 > this.buffer.byteLength)
        throw RangeError(
          'Illegal offset: 0 <= ' + a + ' (+1) <= ' + this.buffer.byteLength,
        );
    }
    a = this.view[a];
    128 === (a & 128) && (a = -(255 - a + 1));
  ...
  e.writeInt16 = function (a, b) {
    ...
    b -= 2;
    this.littleEndian
      ? ((this.view[b + 1] = (a & 65280) >>> 8), (this.view[b] = a & 255))
      : ((this.view[b] = (a & 65280) >>> 8), (this.view[b + 1] = a & 255));
    c && (this.offset += 2);
    return this;
  };
  ...
  e.readInt16 = function (a) {
    ...
    if (!this.noAssert) {
      ...
      if (0 > a || a + 2 > this.buffer.byteLength)
        throw RangeError(
          'Illegal offset: 0 <= ' + a + ' (+2) <= ' + this.buffer.byteLength,
        );
    }
    var c = 0;
    this.littleEndian
      ? ((c = this.view[a]), (c |= this.view[a + 1] << 8))
      : ((c = this.view[a] << 8), (c |= this.view[a + 1]));
  ...
  e.readInt32 = function (a) {
    ...
    if (!this.noAssert) {
      ...
      if (0 > a || a + 4 > this.buffer.byteLength)
        throw RangeError(
          'Illegal offset: 0 <= ' + a + ' (+4) <= ' + this.buffer.byteLength,
        );
    }
    var c = 0;
    this.littleEndian
  ...
  k &&
    ((e.writeInt64 = function (a, b) {
      ...
      if (!this.noAssert) {
        ...
        else if ('string' === typeof a) a = k.fromString(a);
      ...
      'number' === typeof a
        ? (a = k.fromNumber(a))
        : 'string' === typeof a && (a = k.fromString(a));
      b += 8;
      var d = this.buffer.byteLength;
      b > d && this.resize((d *= 2) > b ? d : b);
      b -= 8;
    ...
    (e.readInt64 = function (a) {
      ...
      if (!this.noAssert) {
        ...
        if (0 > a || a + 8 > this.buffer.byteLength)
          throw RangeError(
            'Illegal offset: 0 <= ' + a + ' (+8) <= ' + this.buffer.byteLength,
          );
      }
      var c = 0,
        d = 0;
  ...
  e.readVarint32ZigZag = function (a) {
    ...
    'object' === typeof a
      ? (a.value = h.zigZagDecode32(a.value))
      : (a = h.zigZagDecode32(a));
    return a;
  };
  k &&
    ((h.MAX_VARINT64_BYTES = 10),
    (h.calculateVarint64 = function (a) {
      'number' === typeof a
        ? (a = k.fromNumber(a))
        : 'string' === typeof a && (a = k.fromString(a));
      var b = a.toInt() >>> 0,
    ...
    (h.zigZagDecode64 = function (a) {
      ...
      return a
        ...
        .xor(a.and(k.ONE).toSigned().negate())
        .toSigned();
    }),
    (e.writeVarint64 = function (a, b) {
      ...
      switch (d) {
        ...
        case 7:
          this.view[b + 6] = 7 !== d ? (e >>> 14) | 128 : (e >>> 14) & 127;
        case 6:
    ...
    (e.readVarint64 = function (a) {
      ...
      if (
        ...
        ((g = this.view[a++]),
        (d |= (g & 127) << 7),
        g & 128 || (this.noAssert && 'undefined' === typeof g)) &&
        ((g = this.view[a++]),
        (d |= (g & 127) << 14),
        g & 128 || (this.noAssert && 'undefined' === typeof g)) &&
        ((g = this.view[a++]),
    ...
    (e.readVarint64ZigZag = function (a) {
      (a = this.readVarint64(a)) && a.value instanceof k
        ? (a.value = h.zigZagDecode64(a.value))
        : (a = h.zigZagDecode64(a));
      return a;
    }));
  ...
  e.readCString = function (a) {
    ...
    n.decodeUTF8toUTF16(
      function () {
        ...
        if (a >= this.limit)
          throw RangeError(
            'Illegal range: Truncated data, ' + a + ' < ' + this.limit,
          );
        f = this.view[a++];
        return 0 === f ? null : f;
      }.bind(this),
  ...
  e.readIString = function (a) {
    ...
    var c = a,
      d = this.readUint32(a),
      d = this.readUTF8String(d, h.METRICS_BYTES, (a += 4));
    a += d.length;
    return b
      ? ((this.offset = a), d.string)
      : { string: d.string, length: a - c };
  };
  h.METRICS_CHARS = 'c';
  h.METRICS_BYTES = 'b';
  ...
  e.readUTF8String = function (a, b, c) {
    ...
    if (!this.noAssert) {
      ...
      if (0 > c || c + 0 > this.buffer.byteLength)
        throw RangeError(
          'Illegal offset: 0 <= ' + c + ' (+0) <= ' + this.buffer.byteLength,
        );
    }
    var f = 0,
      e = c,
    ...
    if (b === h.METRICS_BYTES) {
      ...
      if (c !== k)
        throw RangeError('Illegal range: Truncated data, ' + c + ' == ' + k);
      return d ? ((this.offset = c), g()) : { string: g(), length: c - e };
    }
  ...
  e.readVString = function (a) {
    ...
    var c = a,
      ...
      d = this.readUTF8String(d.value, h.METRICS_BYTES, (a += d.length));
    a += d.length;
    return b
      ? ((this.offset = a), d.string)
      : { string: d.string, length: a - c };
  ...
  e.clone = function (a) {
    ...
    a
      ? ((b.buffer = new ArrayBuffer(this.buffer.byteLength)),
  ...
  e.copy = function (a, b) {
    ...
    var c = b - a,
      d = new h(c, this.littleEndian, this.noAssert);
    d.offset = 0;
    d.limit = c;
  ...
  e.copyTo = function (a, b, c, d) {
    ...
    if (0 > b || b > a.buffer.byteLength)
      throw RangeError(
        'Illegal target range: 0 <= ' + b + ' <= ' + a.buffer.byteLength,
      );
    if (0 > c || d > this.buffer.byteLength)
      throw RangeError(
        'Illegal source range: 0 <= ' + c + ' <= ' + this.buffer.byteLength,
      );
    var g = d - c;
    if (0 === g) return a;
  ...
  e.mark = function (a) {
    ...
    if (!this.noAssert) {
      ...
      if (0 > a || a + 0 > this.buffer.byteLength)
        throw RangeError(
          'Illegal offset: 0 <= ' + a + ' (+0) <= ' + this.buffer.byteLength,
        );
    }
    this.markedOffset = a;
    return this;
  ...
  e.toBinary = function (a, b) {
    ...
    for (var c = [], d = []; a < b; )
      (c.push(this.view[a++]),
        1024 <= c.length &&
          (d.push(String.fromCharCode.apply(String, c)), (c = [])));
  ...
  e.toDebug = function (a) {
    for (
      var b = -1, c = this.buffer.byteLength, d, f = '', e = '', g = '';
      b < c;
      ...
      -1 !== b &&
        ...
        a && (e += 32 < d && 127 > d ? String.fromCharCode(d) : '.'));
      ++b;
      if (a && 0 < b && 0 === b % 16 && b !== c) {
        for (; 51 > f.length; ) f += ' ';
        g += f + e + '\n';
    ...
    var a = {
      ...
      decodeUTF8: function (a, c) {
        for (
          ...
          if (0 === (d & 128)) c(d);
            ...
            (null === (f = a()) && h([d, f]), c(((d & 31) << 6) | (f & 63)));
          else if (224 === (d & 240))
            ((null !== (f = a()) && null !== (e = a())) || h([d, f, e]),
              c(((d & 15) << 12) | ((f & 63) << 6) | (e & 63)));
          else if (240 === (d & 248))
            ((null !== (f = a()) && null !== (e = a()) && null !== (g = a())) ||
              h([d, f, e, g]),
              c(
                ((d & 7) << 18) | ((f & 63) << 12) | ((e & 63) << 6) | (g & 63),
              ));
      ...
      UTF16toUTF8: function (a, c) {
        for (var d, e = null; null !== (d = null !== e ? e : a()); )
          ...
          56320 <= e &&
          57343 >= e
            ? (c(1024 * (d - 55296) + e - 56320 + 65536), (e = null))
            : c(d);
        null !== e && c(e);
      },
      UTF8toUTF16: function (a, c) {
        ...
        for (; null !== d || null !== (d = a()); )
          (65535 >= d
            ? c(d)
            : ((d -= 65536), c((d >> 10) + 55296), c((d % 1024) + 56320)),
            (d = null));
      },
  ...
  h.fromUTF8 = function (a, b, c) {
    ...
    var d = new h(n.calculateUTF16asUTF8(m(a), !0)[1], b, c),
      e = 0;
