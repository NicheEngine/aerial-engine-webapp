...
export let useTableForm: typeof useEngineForm;
...
export function setupEngineVxeTable(setupOptions: SetupVxeTable) {
  const { configVxeTable, useEngineForm } = setupOptions;

  initVxeTable();
  useTableForm = useEngineForm;
