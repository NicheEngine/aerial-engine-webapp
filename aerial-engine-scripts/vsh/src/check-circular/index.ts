...
const DEFAULT_CONFIG = {
  ...
  ignoreDirs: [
    ...
    '.cache',
    'scripts',
    'aerial-engine-configures',
    'aerial-engine-packages/effects/request/src/',
    'aerial-engine-packages/@core/ui-kit/menu-ui/src/',
    'aerial-engine-packages/@core/ui-kit/popup-ui/src/',
  ],
  threshold: 0, // 循环依赖的阈值
} as const;
